      ...
      <div className="main-col">
        <div className="banner-dark" style={{ display: 'flex', gap: 28, flexWrap: 'wrap', alignItems: 'flex-end' }}>
          <div className="stack" style={{ flex: 1, minWidth: 320, gap: 10 }}>
            ...
            <p style={{ margin: 0, fontSize: 15, lineHeight: 1.55, color: 'var(--on-dark-2)', maxWidth: '66ch' }}>
          ...
          <div className="stack" style={{ fontSize: 13, color: 'var(--on-dark-4)', gap: 5, flex: 'none' }}>
          ...
          {EVENTS.map((e) => {
            ...
            return (
              <div key={e.title} className="list-row" style={{ borderTop: '1px solid var(--line)', gap: 20, flexWrap: 'wrap' }}>
                <div className="stack" style={{ width: 70, flex: 'none' }}>
                  <span className="serif" style={{ fontSize: 22, fontWeight: 700, lineHeight: 1 }}>{e.day}</span>
                  <Eyebrow>{e.month}</Eyebrow>
                </div>
                <div className="stack" style={{ flex: 1, minWidth: 240, gap: 3 }}>
                  <span style={{ fontSize: 16, fontWeight: 700, lineHeight: 1.3 }}>{e.title}</span>
